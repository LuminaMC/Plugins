...
public class PlayerHeadClick implements Listener
{
    @EventHandler
        ...
        if (e.getView().getTitle().equalsIgnoreCase("§b§lGuide§e§lMenu")) {
            ...
            switch (e.getCurrentItem().getType()) {
                case PLAYER_HEAD: {
                    ...
                    pages.add("§6§l§m     [§b§l LUMINA §6§m§l]     §r\n\nVous pouvez jouer \u00e0 plusieurs sur la m\u00eame \u00eele en invitant d'autres joueurs sur votres \u00eele en faisant la commande §9/is invite <pseudo>§r. Vous pouvez inviter aussi des personnes occasionellement en faisant la commande §9    /is coop <pseudo>§r.");
