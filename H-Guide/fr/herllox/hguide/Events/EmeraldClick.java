...
public class EmeraldClick implements Listener
{
    @EventHandler
        ...
        if (e.getView().getTitle().equalsIgnoreCase("§b§lGuide§e§lMenu")) {
            ...
            switch (e.getCurrentItem().getType()) {
                case EMERALD: {
                    ...
                    pages.add("§6§l§m     [§b§l LUMINA §6§m§l]     §r\n\nVous pouvez soutenir le serveur en votant pour lui, vous obtiendrez une r\u00e9compense. Pour voter il faut faire la commande §9/vote§r et suivre les instructions dans le chat et sur le site de vote.");
